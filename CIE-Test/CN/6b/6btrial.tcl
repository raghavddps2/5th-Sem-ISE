...
set namf [open "6btrial.nam" w]
set trf [open "6btrial.tr" w]
...
proc finish { } {
    ...
    close $trf
    close $namf
    exec gawk -f 6btrial.awk 6btrial.tr &
    exec nam 6btrial.nam &
    exit 0
}
...
set lan1 [$ns newLan "$n3 $n4 $n5 $n6" 10Mb 50ms LL Queue/DropTail MAC/802_3 Channel]
...
set errormod [new ErrorModel]
$errormod set rate_ 0.00
$ns lossmodel $errormod $n2 $n3
