...
#Node n(3), n(4) and n(5) are considered in a LAN 802_3 (not Csma/Cd)
...
#Setup queue between n(2) and n(3) and monitor the queue important
$ns queue-limit $n(2) $n(3) 20
$ns simplex-link-op $n(2) $n(3) queuePos 0.5

#Set error model on link n(2) and n(3) and insert the error model important
